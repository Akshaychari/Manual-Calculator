...
subs=Button(frame,text='-',height=4,width=9,font=35,command=lambda:button_press('-'))
subs.grid(row=1,column=3)
...
decimal=Button(frame,text='.',height=4,width=9,font=35,command=clear)
